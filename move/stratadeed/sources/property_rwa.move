module stratadeed::property_rwa {
    ...
    public fun deposit_escrow(
        ...
        assert!(treasury.escrow_state == STATE_FUNDING, 1); // Only accept during funding phase
        assert!(treasury.total_escrow_raised + amount <= treasury.funding_cap, 2); // Don't exceed cap
    ...
    public fun distribute_yield(
        ...
        assert!(treasury.total_escrow_raised >= amount, 3); // Ensure sufficient balance
