							...
							<form
								...
								<button
									...
									{isLoading ? (
										...
										<>
											<LogIn className="w-4 h-4 group-hover:scale-110 transition-transform relative" />
								...
								<div className="grid grid-cols-2 gap-2">
									<button
										...
										disabled={isLoading}
										className="flex items-center justify-center gap-2 px-3 py-2 text-xs bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 hover:scale-[1.02] transition-all duration-200 group/social disabled:opacity-50 disabled:cursor-not-allowed">
