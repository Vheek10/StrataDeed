			...
			<div className="w-full max-w-md">
				...
				<div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-xl p-8">
					...
					<div className="text-center mb-8">
						<div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-accent-2/10 to-accent-2-light/10 rounded-2xl flex items-center justify-center">
							<LogIn className="w-8 h-8 text-accent-2" />
						</div>
						<h1 className="text-2xl font-bold text-gray-900 dark:text-white">
							Welcome Back
						</h1>
						<p className="text-gray-600 dark:text-gray-400 mt-2">
							Sign in to your StrataDeed account
						</p>
					</div>
					...
					<form
							...
							<div className="flex items-center justify-between mt-3">
								<label className="flex items-center gap-2 cursor-pointer">
									<input
										...
										className="w-4 h-4 text-accent-2 rounded focus:ring-accent-2"
									/>
								...
								<Link
									...
									className="text-sm font-medium text-accent-2 hover:text-accent-2-dark transition-colors">
									Forgot password?
								</Link>
							</div>
						</div>
						...
						<button
							...
							className={cn(
								...
								"bg-gradient-to-r from-accent-2 to-accent-2-light text-white font-semibold rounded-lg",
								"hover:shadow-lg hover:shadow-accent-2/30 transition-all duration-300",
