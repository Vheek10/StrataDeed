...
export default function PropertyCard({
	...
	// Local handler for Details button
						...
						<div className="mt-auto">
							...
							<div className="flex flex-col xs:flex-row gap-2">
								...
								<button
									...
									className="px-4 py-3 bg-gradient-to-r from-emerald-600 to-teal-500 text-white font-semibold rounded-xl hover:shadow-xl hover:scale-[1.02] hover:from-emerald-700 hover:to-teal-600 transition-all duration-300 flex items-center justify-center gap-2 min-h-[48px] xs:flex-none xs:w-auto w-full">
