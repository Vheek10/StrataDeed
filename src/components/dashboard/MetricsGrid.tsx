		...
		<div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-8">
			{metrics.map((metric) => {
				...
				return (
					<div
						key={metric.id}
						className={`relative overflow-hidden bg-white rounded-xl md:rounded-2xl p-4 md:p-6 border border-gray-100 hover:shadow-lg transition-all duration-300 group`}>
						<div
						...
						<div className="relative z-10">
							<div className="flex items-center justify-between mb-3 md:mb-4">
								...
								<div className="flex items-center gap-0.5 md:gap-1 px-1.5 py-0.5 md:px-2.5 md:py-1 bg-emerald-50 text-emerald-600 rounded-md md:rounded-lg text-[10px] md:text-xs font-semibold">
							...
							<div>
								<div className="text-xs md:text-sm font-medium text-gray-500 mb-0.5 md:mb-1 truncate">
									{metric.title}
								</div>
								<div className="text-lg md:text-3xl font-bold text-gray-900 tracking-tight">
									{metric.value}
								</div>
							</div>
						</div>
